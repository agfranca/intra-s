...
{!! Form::open(['route' => ['painel.redistribuir.updade',$noticia],'method' => 'PUT','class'=>'form-horizontal']) !!}
<div class="col-md-8">
  <div class="box box-info">
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                    {!! Form::textarea('noticia', $noticia->noticia, ['placeholder' => 'Cadastre sua Notícia ','class' => 'form-control','required','disabled']) !!}
                  </div>
                </div>
...
@include('painel.noticias.partes.departamentos-empresas-redistribuir')
