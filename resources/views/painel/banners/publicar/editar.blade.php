...
<div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Banners para o Usuário Editar</h3>
                    ...
                    <td>
                      ...
                      @if($banner -> publicado =='N')
                        ...
                        @else
                          ...
                          <button class="btn btn-xs btn-warning" data-toggle="modal" data-target="#ModalEditarPublicar" title="Distribuir"> Editar Publicação </button>
...
<!-- Modal Editar Publicação -->
                      <div class="modal fade" id="ModalEditarPublicar" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div style="padding:0; margin: 0" class="modal-body">
                              {!! Form::open(['url' =>array('/painel/banners/publicar/editar', $bannerEditar->id),'method' => 'PUT','class'=>'form-horizontal']) !!}
