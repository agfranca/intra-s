...
<div id="actions">
      ...
      <div id="inserir2" style="display: block;">
...
<!-- FIM MODAL Publicar -->
                          ...
                          {!! Form::open(['route' =>['painel.banners.publicar',$banner->id],'method' => 'PUT','class'=>'form-inline','style'=>'display: inline']) !!}

                          <input type="hidden" value="{{ $banner -> id}}" name="banner_id" id="banner_id" required="">

                          {!! Form::submit('Publicar', ['class' => 'btn btn-xs btn-success']); !!}
