...
{!! Form::open(['route' =>['painel.usuarios.updade',$usuario],'method' => 'PUT','class'=>'form-horizontal']) !!}
<div class="col-md-8">
  <div class="box box-info">
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                    {!! Form::text('nome',$usuario->name, ['placeholder' => 'Cadastre o Usuário','class' => 'form-control', 'required']) !!}
                  </div>
                </div>
...
@include('painel.usuarios.partes.departamentos-empresas-editar')
