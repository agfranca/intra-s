...
<section class="content-header">
      <h1>
        Empresas
        <small> - Cadastrar Empresas</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href={{ route('painel') }}><i class="fa fa-dashboard"></i> Painel</a></li>
        <li><a href={{ route('painel.empresas.index') }}><i class="fa fa-briefcase"></i> Empresas</a></li>
  ...
  <div class="box box-info">
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                    {!! Form::text('nome', '', ['placeholder' => 'Cadastre a Empresa','class' => 'form-control', 'required']) !!}
                  </div>
                </div>
