<div class="col-md-12">
        <div class="modal fade pg-show-modal" id="editartarefas" tabindex="-1" role="dialog" aria-hidden="true"> 
            ...
            <div class="modal-content"> 
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <input placeholder="Digite o Nome da Tarefa" name="tarefa" type="text" required class="form-control form" value="{{ $entrada->nome}}">
                </div>
                
                <div class="form-group">
                  <textarea title="Descrição da Tarefa" class="form-control form" name="descricao" placeholder="Descrição da Tarefa" value="{{ $entrada->descricao}}"></textarea>
                </div>
                ...
                <div style="padding-left: 0px;" class="col-md-6">
                  ...
                  <input placeholder="Digite a data de Entrega" type="date" name="entrega" class="form-control form" value="{{ $entrada->entrega}}">
                </div>
                ...
                <div style="padding-right: 0px;" class="col-md-6">
                  ...
                  <select id="formInput146" class="form-control" name="prioridade"> 
                    <? 
                    $ln = array("Baixa", "Normal", "Alta");
                    foreach ($ln as $val) {
                    if({{ $entrada->prioridade}} == $val){
                    $x = "selected";
                    }else{
                    $x = "";
                    }
                    echo "<option value=\"$val\"<b>$x</b>>$val</option>\n"; 
                    }
                    ?>
                  </select>
                </div>
