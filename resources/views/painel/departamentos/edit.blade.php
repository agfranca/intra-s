...
{!! Form::open(['route' =>['painel.departamentos.updade',$departamento],'method' => 'PUT','class'=>'form-horizontal']) !!}
<div class="col-md-8">
  <div class="box box-info">
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-12">
                    {!! Form::text('nome', $departamento->nome, ['placeholder' => 'Editar o Departamento','class' => 'form-control', 'required']) !!}
                  </div>
                </div>
              </div>
  </div>
...
@include('painel.departamentos.partes.empresas-editar')
